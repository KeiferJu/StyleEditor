...
export default class Toolbar extends React.Component {
  ...
  render() {
    return <div className='maputnik-toolbar'>
      ...
      />
      {/*<ToolbarLink href={"http://www.lingtu.com"} className="maputnik-toolbar-logo">*/}
        {/*<img src={logoImage} alt="Maputnik" />*/}
        {/*<h1>Maputnik</h1>*/}
      {/*</ToolbarLink>*/}

      {/*<a  href="http://www.smartmapx.com" className="maputnik-toolbar-logo">*/}
        {/*<img src={logoImage} alt="Maputnik" />*/}
      {/*</a>*/}
      ...
      <span>我的地图</span>
        ...
        <ToolbarAction onClick={this.props.onInspectModeToggle}>
          ...
          <IconText>
            ...
            { !this.props.inspectModeEnabled && <span>分析模式</span> }
          </IconText>
        </ToolbarAction>

      {/*<ToolbarLink href={"http://www.smartmapx.com"}>*/}
        {/*<HelpIcon />*/}
