...
import LayerChart from './layers/LayerChart'
...
import validateStyleMin from '../style-spec/lib/validate_style.min'
...
export default class App extends React.Component {
  constructor(props) {
    ...
    const styleUrl = "http://114.247.222.102:33012/style2.json";
    if(styleUrl) {
    ...
    this.state = {
      ...
      spec: GlSpec,
      classDrawer: 'maputnik-layout-drawer1',
      chartData: ''
    }
  ...
  onLayerSelect(layerId) {
    this.setState({
      classDrawer: 'maputnik-layout-drawer'
    });
  ...
  render() {
    ...
    const layerChart = this.state.chartData ? <LayerChart /> : null;
    // 入口
    return <AppLayout
      toolbar={toolbar}
      layerList={layerList}
      ...
      classDrawer={this.state.classDrawer}
